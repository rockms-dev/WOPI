    ...
    public function __invoke(WopiRequest $request, string $fileId, WopiInterface $wopiImplementation)
    {
        ...
        switch ($request->header(WopiInterface::HEADER_OVERRIDE)) {
           case 'LOCK':
                ...
                break;
           case 'GET_LOCK': return app(GetLockController::class)($request, $fileId, $wopiImplementation); break;
           case 'REFRESH_LOCK': return app(RefreshLockController::class)($request, $fileId, $wopiImplementation); break;
           case 'UNLOCK': return app(UnlockController::class)($request, $fileId, $wopiImplementation); break;
           case 'PUT_RELATIVE': return app(PutRelativeFileController::class)($request, $fileId, $wopiImplementation); break;
           case 'RENAME_FILE': return app(RenameFileController::class)($request, $fileId, $wopiImplementation); break;
           case 'DELETE': return app(DeleteFileController::class)($request, $fileId, $wopiImplementation); break;
           case 'PUT_USER_INFO': return app(PutUserInfoController::class)($request, $fileId, $wopiImplementation); break;
